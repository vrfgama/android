...
package br.usjt.ciclodevidaactivity_2.Util;
...
public class Utils {
    ...
    private static br.usjt.ciclodevidaactivity_2.Util.StatusTracker mStatusTracker = br.usjt.ciclodevidaactivity_2.Util.StatusTracker.getInstance();
